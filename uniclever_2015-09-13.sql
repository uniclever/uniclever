...
# Database: uniclever
# Generation Time: 2015-09-13 03:03:28 +0000
# ************************************************************
...
--
-- Dumping routines (PROCEDURE) for database 'uniclever'
--
DELIMITER ;;

# Dump of PROCEDURE usp_box_create
# ------------------------------------------------------------

/*!50003 DROP PROCEDURE IF EXISTS `usp_box_create` */;;
/*!50003 SET SESSION SQL_MODE="NO_ENGINE_SUBSTITUTION"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `usp_box_create`(
	IN pCustID INT,
    IN pDelivery_cycle_w INT
)
BEGIN
...
# Dump of PROCEDURE usp_get_template_box
# ------------------------------------------------------------

/*!50003 DROP PROCEDURE IF EXISTS `usp_get_template_box` */;;
/*!50003 SET SESSION SQL_MODE="NO_ENGINE_SUBSTITUTION"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `usp_get_template_box`(IN pTemplate INT )
BEGIN
	SELECT tbi.*, p.* 
    FROM template_box tb 
    INNER JOIN template_box_item tbi ON tb.template_box_id = tbi.template_box_id
    INNER JOIN product p ON tbi.product_id = p.product_id;
